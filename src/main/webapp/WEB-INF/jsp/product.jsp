...
<body id="productPage">
    ...
    <div class="page-title-section section" data-bg-image="assets/images/product/product_top.jpg">
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <div class="page-title">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">${productId}</li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-6 col-12 learts-mb-40">
                    <div class="product-images">
                        ...
                        <div class="product-gallery-slider">
                            <div class="" data-image="assets/images/product/single/1/product-zoom-1.jpg">
                ...
                <div class="col-lg-6 col-12 learts-mb-40">
                    <div class="product-summery">
                        ...
                        <div class="product-buttons">
                            <a href="javascript:void(0);" class="btn btn-icon btn-outline-body btn-hover-dark hintT-top" id="AddToWishlist" data-hint="Add to Wishlist"><i class="fal fa-heart"></i></a>
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                ...
                                <img src="assets/images/product/s328/product_7.jpg" alt="Product Image">
